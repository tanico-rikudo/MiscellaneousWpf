...
namespace LiveChartPlay.Views
{
    ...
    /// </summary>
    public partial class MainWindowMaterialDesign : Window
    {
        private readonly SnackbarMessageQueue _snackbarQueue = new SnackbarMessageQueue();

        public MainWindowMaterialDesign(MainViewModel viewModel, IMessengerService messenger, IContainerProvider container, IAppStateService appStateService)
        {
            InitializeComponent();
